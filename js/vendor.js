...
! function(t, e) {
    ...
    var u = function(t) {
        ...
        b = !a && !r(function() {
            return 7 != Object.defineProperty(("div", A ? _.createElement("div") : {}), "a", {
                get: function() {
                    return 7
                }
            }).a
    ...
    if (R) {
        ...
        var W = z[I = "state"] || (z[I] = function(t) {
            return "Symbol(" + String(t) + ")_" + (++N + U).toString(36)
        }(I));
    ...
    var $ = {
        ...
        wt = !Dt || r(function() {
            ...
            for (var n = Object(d(t)), u = arguments.length, i = 1, r = dt.f, s = l.f; u > i;)
                for (var o, h = p(arguments[i++]), c = r ? St(h).concat(r(h)) : St(h), f = c.length, v = 0; f > v;) o = c[v++], a && !s.call(h, o) || (n[o] = h[o]);
            return n
        } : Dt;
    Ft({
        target: "Object",
    ...
    var Mt = "".repeat || function(t) {
        ...
        Pt = function(t) {
            return function(e, n, u) {
                var i, r, a = String(d(e)),
                    ...
                    o = void 0 === u ? " " : String(u),
                    l = rt(n);
                return l <= s || "" == o ? a : (i = l - s, (r = Mt.call(o, xt(i / o.length))).length > i && (r = r.slice(0, i)), t ? a + r : r + a)
            }
        },
        Ot = {
            start: Pt(!1),
        ...
        Tt = tt("navigator", "userAgent") || "",
        It = /Version\/10\.\d+(\.\d+)?( Mobile\/\w+)? Safari\//.test(Tt),
        jt = Ot.end;
    Ft({
        target: "String",
        proto: !0,
    ...
    function Gt(t, e, n, u) {
        return (Gt = "undefined" != typeof Reflect && Reflect.set ? Reflect.set : function(t, e, n, u) {
            var i, r = Kt(t, e);
            if (r) {
    ...
    function Wt(t, e, n, u, i) {
        if (!Gt(t, e, n, u || t) && i) throw new Error("failed to set property");
        return n
    }
    ...
    var ie = function() {
            ...
            return Ut(t, [{
                ...
                key: "removeDirection",
                get: function() {
                    return !this.removedCount || this.insertedCount ? Jt : this.oldSelection.end === this.cursorPos || this.oldSelection.start === this.cursorPos ? ee : Qt
                }
            }]), t
        }(),
        re = function() {
    ...
    var oe = function() {
        ...
        return Ut(t, [{
            ...
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                    e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length;
                return new ae(this.extractInput(t, e), t)
            }
        }, {
            key: "appendTail",
            value: function(t) {
                return Xt(t) && (t = new ae(String(t))), t.appendTo(this)
            }
        }, {
            key: "_appendCharRaw",
            value: function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                return (t = this.doPrepare(t, e)) ? (this._value += t, new re({
                    inserted: t,
                    rawInserted: t
                })) : new re
            }
            ...
            value: function(t) {
                ...
                if (i.inserted) {
                    ...
                    a || (i = new re, this.state = u, n && r && (n.state = r))
                }
                return i
            }
        }, {
            ...
            value: function(t, e, n) {
                if (!Xt(t)) throw new Error("value should be string");
                var u = new re,
                    i = Xt(n) ? new ae(String(n)) : n;
    ...
    function le(t) {
        ...
        return t instanceof RegExp ? se.MaskedRegExp : Xt(t) ? se.MaskedPattern : t instanceof Date || t === Date ? se.MaskedDate : t instanceof Number || "number" == typeof t || t === Number ? se.MaskedNumber : Array.isArray(t) || t === Array ? se.MaskedDynamic : se.Masked && t.prototype instanceof se.Masked ? t : t instanceof Function ? se.MaskedFunction : t instanceof se.Masked ? t.constructor : (console.warn("Mask not found for mask", t), se.Masked)
    }
    ...
    var ce = {
        ...
        pe = function() {
            ...
            return Ut(t, [{
                ...
                key: "extractTail",
                value: function() {
                    return arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length, new ae("")
                }
            }, {
                key: "appendTail",
                value: function(t) {
        ...
        de = function() {
            ...
            return Ut(t, [{
                ...
                value: function(e) {
                    if (String(e)) {
                        Xt(e) && (e = new ae(String(e)));
                        var n = this.chunks[this.chunks.length - 1],
                            u = n && (n.stop === e.stop || null == e.stop) && e.from === n.from + n.toString().length;
                        if (e instanceof ae) u ? n.extend(e.toString()) : this.chunks.push(e);
                ...
                key: "appendTo",
                value: function(e) {
                    if (!(e instanceof se.MaskedPattern)) return new ae(this.toString()).appendTo(e);
                ...
                set: function(e) {
                    ...
                    Object.assign(this, u), this.chunks = n.map(function(e) {
                        var n = "chunks" in e ? new t : new ae;
                        return n.state = e, n
                    })
                }
            }]), t
        ...
        ve = function(t) {
            function e() {
                return Lt(this, e), Zt(this, Ht(e).apply(this, arguments))
            }
            return zt(e, oe), Ut(e, [{
                key: "_update",
                value: function(t) {
                    ...
                    }), qt(Ht(e.prototype), "_update", this).call(this, t)
                }
            }]), e
        }();
    se.MaskedRegExp = ve;
    var ke = function(t) {
        function e() {
            ...
            return Lt(this, e), t.definitions = Object.assign({}, ce, t.definitions), Zt(this, Ht(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)))
        }
        return zt(e, oe), Ut(e, [{
            key: "_update",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                t.definitions = Object.assign({}, this.definitions, t.definitions), qt(Ht(e.prototype), "_update", this).call(this, t), this._rebuildMask()
            }
        }, {
            key: "_rebuildMask",
            value: function() {
            ...
            key: "reset",
            value: function() {
                qt(Ht(e.prototype), "reset", this).call(this), this._blocks.forEach(function(t) {
                    return t.reset()
                })
            }
        }, {
            ...
            value: function() {
                this._blocks.forEach(function(t) {
                    return t.doCommit()
                }), qt(Ht(e.prototype), "doCommit", this).call(this)
            }
        }, {
            key: "appendTail",
            value: function(t) {
                return qt(Ht(e.prototype), "appendTail", this).call(this, t).aggregate(this._appendPlaceholder())
            }
        }, {
            key: "_appendCharRaw",
            value: function(t) {
            ...
            value: function() {
                ...
                return e === n ? u : (this._forEachBlocksInRange(e, n, function(e, n, i, r) {
                    ...
                    a.stop = t._findStopBefore(n), a.from = t._blockStartPos(n), a instanceof de && (a.blockIndex = n), u.extend(a)
                }), u)
            }
        }, {
            key: "extractInput",
            ...
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                    n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length,
                    u = qt(Ht(e.prototype), "remove", this).call(this, t, n);
                ...
                if (e === Qt || e === te) {
                    for (var y, m = o; m < this._blocks.length; ++m)
                        ...
                        var _ = this._blocks[y],
                            A = _.nearestInputPos(0, ee);
                        if (0 === A && _.unmaskedValue.length) return this._blockStartPos(y) + A
                    }
                    for (var b, C = -1, E = o - 1; E >= 0; --E) {
                        var F = this._blocks[E],
                            S = F.nearestInputPos(F.value.length, te);
                        if (F.value && 0 === S || (b = E), 0 !== S) {
                            if (S !== F.value.length) return this._blockStartPos(E) + S;
                            C = E;
                            break
                        }
                    }
                    if (e === Qt)
                        for (var D = C + 1; D <= Math.min(o, this._blocks.length - 1); ++D) {
                            var B = this._blocks[D],
                                w = B.nearestInputPos(0, Jt),
                                M = this._blockStartPos(D) + w;
                            if (M > t) break;
                            if (w !== B.value.length) return M
                        }
                    if (C >= 0) return this._blockStartPos(C) + this._blocks[C].value.length;
                    if (e === te || this.lazy && !this.extractInput() && ! function(t) {
                            if (!t) return !1;
                            var e = t.value;
                            return !e || t.nearestInputPos(0, Jt) !== e.length
                        }(this._blocks[o])) return 0;
                    if (null != b) return this._blockStartPos(b);
                    for (var x = o; x < this._blocks.length; ++x) {
                        var P = this._blocks[x],
                            O = P.nearestInputPos(0, Jt);
                        if (!P.value.length || O !== P.value.length) return this._blockStartPos(x) + O
                    }
                    return 0
                }
                if (e === ee || e === ne) {
                    for (var T, I, j = o; j < this._blocks.length; ++j) {
                        var V = this._blocks[j],
                            R = V.nearestInputPos(0, Jt);
                        if (R !== V.value.length) {
                            I = this._blockStartPos(j) + R, T = j;
                            break
                        }
                    }
                    if (null != T && null != I) {
                        for (var L = T; L < this._blocks.length; ++L) {
                            var N = this._blocks[L],
                                U = N.nearestInputPos(0, ne);
                            if (U !== N.value.length) return this._blockStartPos(L) + U
                        }
                        return e === ne ? this.value.length : I
                    }
                    for (var z = Math.min(o, this._blocks.length - 1); z >= 0; --z) {
                        var H = this._blocks[z],
                            Y = H.nearestInputPos(H.value.length, Qt);
                        if (0 !== Y) {
                            var Z = this._blockStartPos(z) + Y;
                            if (Z >= t) return Z;
                            break
                        }
                    }
            ...
            key: "state",
            get: function() {
                return Object.assign({}, qt(Ht(e.prototype), "state", this), {
            ...
            set: function(t) {
                ...
                this._blocks.forEach(function(t, e) {
                    return t.state = n[e]
                }), Wt(Ht(e.prototype), "state", u, this, !0)
            }
        }, {
            key: "isComplete",
            get: function() {
            ...
            set: function(t) {
                Wt(Ht(e.prototype), "unmaskedValue", t, this, !0)
            }
        }, {
            key: "value",
            get: function() {
            ...
            set: function(t) {
                Wt(Ht(e.prototype), "value", t, this, !0)
            }
        }]), e
    }();
    ke.DEFAULTS = {
        lazy: !0,
        placeholderChar: "_"
    }, ke.STOP_CHAR = "`", ke.ESCAPE_CHAR = "\\", ke.InputDefinition = fe, ke.FixedDefinition = pe, se.MaskedPattern = ke;
    var ge = function(t) {
        function e() {
            return Lt(this, e), Zt(this, Ht(e).apply(this, arguments))
        }
        return zt(e, ke), Ut(e, [{
            ...
            value: function(t) {
                ...
                t.mask = i.slice(0, r).replace(/0/g, "\\0") + "0".repeat(n - r), qt(Ht(e.prototype), "_update", this).call(this, t)
            }
        }, {
            key: "boundaries",
            value: function(t) {
            ...
            value: function(t) {
                ...
                if (t = qt(Ht(e.prototype), "doPrepare", this).call(this, t, n).replace(/\D/g, ""), !this.autofix) return t;
            ...
            value: function() {
                ...
                for (var u = $t(this.boundaries(n), 2), i = u[0], r = u[1], a = arguments.length, s = new Array(a), o = 0; o < a; o++) s[o] = arguments[o];
                return this.from <= Number(r) && Number(i) <= this.to && (t = qt(Ht(e.prototype), "doValidate", this)).call.apply(t, [this].concat(s))
            }
        }, {
            key: "_matchFrom",
            get: function() {
            ...
            key: "isComplete",
            get: function() {
                return qt(Ht(e.prototype), "isComplete", this) && Boolean(this.value)
            }
        }]), e
    }();
    se.MaskedRange = ge;
    var ye = function(t) {
        function e(t) {
            return Lt(this, e), Zt(this, Ht(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)))
        }
        return zt(e, ke), Ut(e, [{
            key: "_update",
            value: function(t) {
            ...
            value: function() {
                ...
                return (t = qt(Ht(e.prototype), "doValidate", this)).call.apply(t, [this].concat(i)) && (!this.isComplete || this.isDateExist(this.value) && null != n && (null == this.min || this.min <= n) && (null == this.max || n <= this.max))
            }
        }, {
            key: "isDateExist",
            value: function(t) {
            ...
            key: "typedValue",
            get: function() {
                return this.isComplete ? qt(Ht(e.prototype), "typedValue", this) : null
            },
            set: function(t) {
                Wt(Ht(e.prototype), "typedValue", t, this, !0)
            }
        }]), e
    }();
    ye.DEFAULTS = {
    ...
    }, ye.GET_DEFAULT_BLOCKS = function() {
        return {
            d: {
                mask: ge,
                from: 1,
    ...
    var _e = function(t) {
        function e(t) {
            var n;
            return Lt(this, e), (n = Zt(this, Ht(e).call(this))).input = t, n._handlers = {}, n
        }
        return zt(e, me), Ut(e, [{
            key: "_unsafeSelect",
            value: function(t, e) {
    ...
    se.HTMLContenteditableMaskElement = Ae;
    var be = function() {
        function t(e, n) {
            Lt(this, t), this.el = e instanceof me ? e : e.isContentEditable && "INPUT" !== e.tagName && "TEXTAREA" !== e.tagName ? new Ae(e) : new _e(e), this.masked = he(n), this._listeners = {}, this._value = "", this._unmaskedValue = "", this._saveSelection = this._saveSelection.bind(this), this._onInput = this._onInput.bind(this), this._onChange = this._onChange.bind(this), this._onDrop = this._onDrop.bind(this), this._onFocus = this._onFocus.bind(this), this._onClick = this._onClick.bind(this), this.alignCursor = this.alignCursor.bind(this), this.alignCursorFriendly = this.alignCursorFriendly.bind(this), this._bindEvents(), this.updateValue(), this._onChange()
        }
        return Ut(t, [{
            key: "maskEquals",
            value: function(t) {
                return null == t || t === this.masked.mask || t === Date && this.masked instanceof ye
            }
        }, {
            key: "_bindEvents",
            value: function() {
            ...
            value: function(t) {
                var e = t.mask,
                    ...
                    i = ! function t(e, n) {
                        ...
                        if (i != r) return !1;
                        if (n && e && "object" === Rt(n) && "object" === Rt(e)) {
            ...
            key: "alignCursor",
            value: function() {
                this.cursorPos = this.masked.nearestInputPos(this.cursorPos, Qt)
            }
        }, {
            ...
            value: function(t) {
                ...
                var e = new ie(this.el.value, this.cursorPos, this.value, this._selection),
                    n = this.masked.rawInputValue,
                    u = this.masked.splice(e.startChangePos, e.removed.length, e.inserted, e.removeDirection).offset,
                    i = n === this.masked.rawInputValue ? e.removeDirection : Jt,
            ...
            set: function(t) {
                if (!this.maskEquals(t))
                    if (t instanceof se.Masked || this.masked.constructor !== le(t)) {
                        var e = he({
                            mask: t
                        });
    ...
    var Ce = function(t) {
        ...
        return zt(e, ke), Ut(e, [{
            key: "_update",
            value: function(t) {
                t.enum && (t.mask = "*".repeat(t.enum[0].length)), qt(Ht(e.prototype), "_update", this).call(this, t)
            }
        }, {
            key: "doValidate",
            value: function() {
                ...
                }) && (t = qt(Ht(e.prototype), "doValidate", this)).call.apply(t, [this].concat(i))
            }
        }]), e
    }();
    se.MaskedEnum = Ce;
    var Ee = function(t) {
        ...
        return zt(e, oe), Ut(e, [{
            key: "_update",
            value: function(t) {
                qt(Ht(e.prototype), "_update", this).call(this, t), this._updateRegExps()
            }
        }, {
            key: "_updateRegExps",
            value: function() {
            ...
            value: function(t) {
                ...
                return (n = qt(Ht(e.prototype), "doPrepare", this)).call.apply(n, [this, this._removeThousandsSeparators(t.replace(this._mapToRadixRegExp, this.radix))].concat(i))
            }
        }, {
            ...
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                    n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length,
                    u = arguments.length > 2 ? arguments[2] : void 0,
                    i = $t(this._adjustRangeWithSeparators(t, n), 2);
                return t = i[0], n = i[1], this._removeThousandsSeparators(qt(Ht(e.prototype), "extractInput", this).call(this, t, n, u))
            }
        }, {
            key: "_appendCharRaw",
            value: function(t) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                if (!this.thousandsSeparator) return qt(Ht(e.prototype), "_appendCharRaw", this).call(this, t, n);
                var u = n.tail && n._beforeTailState ? n._beforeTailState._value : this._value,
                    i = this._separatorsCountFromSlice(u);
                this._value = this._removeThousandsSeparators(this.value);
                var r = qt(Ht(e.prototype), "_appendCharRaw", this).call(this, t, n);
            ...
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                    e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.value.length,
                    n = $t(this._adjustRangeWithSeparators(t, e), 2);
                t = n[0], e = n[1];
            ...
            value: function(t) {
                ...
                return n && qt(Ht(e.prototype), "doValidate", this).call(this, t)
            }
        }, {
            key: "doCommit",
            value: function() {
            ...
            set: function(t) {
                Wt(Ht(e.prototype), "unmaskedValue", t.replace(".", this.radix), this, !0)
            }
        }, {
            key: "typedValue",
            get: function() {
            ...
            set: function(t) {
                Wt(Ht(e.prototype), "unmaskedValue", String(t), this, !0)
            }
        }, {
            key: "number",
            get: function() {
    ...
    var Fe = function(t) {
        ...
        return zt(e, oe), Ut(e, [{
            key: "_update",
            value: function(t) {
                t.mask && (t.validate = t.mask), qt(Ht(e.prototype), "_update", this).call(this, t)
            }
        }]), e
    }();
    se.MaskedFunction = Fe;
    var Se = function(t) {
        function e(t) {
            var n;
            return Lt(this, e), (n = Zt(this, Ht(e).call(this, Object.assign({}, e.DEFAULTS, {}, t)))).currentMask = null, n
        }
        return zt(e, oe), Ut(e, [{
            key: "_update",
            value: function(t) {
                qt(Ht(e.prototype), "_update", this).call(this, t), "mask" in t && (this.compiledMasks = Array.isArray(t.mask) ? t.mask.map(function(t) {
                    return he(t)
                }) : [])
            }
        }, {
            ...
            value: function() {
                ...
                return this.currentMask && e.aggregate((t = this.currentMask)._appendChar.apply(t, arguments)), e
            }
        }, {
            key: "_applyDispatch",
            value: function() {
            ...
            value: function() {
                ...
                return (t = qt(Ht(e.prototype), "doValidate", this)).call.apply(t, [this].concat(i)) && (!this.currentMask || (n = this.currentMask).doValidate.apply(n, i))
            }
        }, {
            key: "reset",
            value: function() {
            ...
            value: function() {
                for (var t, n, u = arguments.length, i = new Array(u), r = 0; r < u; r++) i[r] = arguments[r];
                return this.currentMask ? (t = this.currentMask).extractTail.apply(t, i) : (n = qt(Ht(e.prototype), "extractTail", this)).call.apply(n, [this].concat(i))
            }
        }, {
            key: "doCommit",
            value: function() {
                this.currentMask && this.currentMask.doCommit(), qt(Ht(e.prototype), "doCommit", this).call(this)
            }
        }, {
            key: "nearestInputPos",
            value: function() {
                for (var t, n, u = arguments.length, i = new Array(u), r = 0; r < u; r++) i[r] = arguments[r];
                return this.currentMask ? (t = this.currentMask).nearestInputPos.apply(t, i) : (n = qt(Ht(e.prototype), "nearestInputPos", this)).call.apply(n, [this].concat(i))
            }
        }, {
            key: "value",
            get: function() {
            ...
            set: function(t) {
                ...
                this.compiledMasks.forEach(function(t, e) {
                    return t.state = n[e]
                }), null != u && (this.currentMask = u, this.currentMask.state = i), Wt(Ht(e.prototype), "state", r, this, !0)
            }
        }, {
            key: "overwrite",
            get: function() {
                return this.currentMask ? this.currentMask.overwrite : qt(Ht(e.prototype), "overwrite", this)
            },
            set: function(t) {
    ...
    se.PIPE_TYPE = De, se.createPipe = Be, se.pipe = we;
    try {
        globalThis.IMask = se
    } catch (t) {}
    t.HTMLContenteditableMaskElement = Ae, t.HTMLMaskElement = _e, t.InputMask = be, t.MaskElement = me, t.Masked = oe, t.MaskedDate = ye, t.MaskedDynamic = Se, t.MaskedEnum = Ce, t.MaskedFunction = Fe, t.MaskedNumber = Ee, t.MaskedPattern = ke, t.MaskedRange = ge, t.MaskedRegExp = ve, t.PIPE_TYPE = De, t.createMask = he, t.createPipe = Be, t.default = se, t.pipe = we, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});
